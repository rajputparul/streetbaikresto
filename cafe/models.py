...
class Order(models.Model):
 STATUSES=[(x,x) for x in ["Pending","Confirmed","Preparing","Ready","Completed","Cancelled"]]
 public_id=models.CharField(max_length=40,unique=True); customer_name=models.CharField(max_length=120); email=models.EmailField(blank=True); phone=models.CharField(max_length=20); address=models.TextField(blank=True); order_type=models.CharField(max_length=20); table_no=models.CharField(max_length=30,blank=True); instructions=models.TextField(blank=True); latitude=models.FloatField(null=True,blank=True); longitude=models.FloatField(null=True,blank=True); subtotal=models.DecimalField(max_digits=10,decimal_places=2); delivery_charge=models.DecimalField(max_digits=10,decimal_places=2,default=0); tax=models.DecimalField(max_digits=10,decimal_places=2,default=0); total=models.DecimalField(max_digits=10,decimal_places=2); payment_method=models.CharField(max_length=60); payment_status=models.CharField(max_length=30,default="Pending"); status=models.CharField(max_length=30,choices=STATUSES,default="Pending"); items_json=models.JSONField(default=list); created_at=models.DateTimeField(default=timezone.now); updated_at=models.DateTimeField(auto_now=True)
